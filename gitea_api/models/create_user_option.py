...
class CreateUserOption(object):
    ...
    def __init__(self, email=None, full_name=None, login_name=None, must_change_password=None, password=None, send_notify=None, source_id=None, username=None, visibility=None):  # noqa: E501
