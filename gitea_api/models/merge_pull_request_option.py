...
class MergePullRequestOption(object):
    ...
    def __init__(self, do=None, merge_commit_id=None, merge_message_field=None, merge_title_field=None, delete_branch_after_merge=None, force_merge=None):  # noqa: E501
