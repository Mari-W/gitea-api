...
class RepositoryApi(object):
    ...
    def repo_create_release_attachment(self, attachment, owner, repo, id, **kwargs):  # noqa: E501
        """Create a release attachment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_create_release_attachment(attachment, owner, repo, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.repo_create_release_attachment_with_http_info(attachment, owner, repo, id, **kwargs)  # noqa: E501
        else:
            (data) = self.repo_create_release_attachment_with_http_info(attachment, owner, repo, id, **kwargs)  # noqa: E501
            return data

    def repo_create_release_attachment_with_http_info(self, attachment, owner, repo, id, **kwargs):  # noqa: E501
        """Create a release attachment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_create_release_attachment_with_http_info(attachment, owner, repo, id, async_req=True)
        >>> result = thread.get()
